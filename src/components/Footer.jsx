...
const Footer = () => {
  const socialLinks = [
    {
      name: 'Pinterest',
      url: 'https://br.pinterest.com/getmenomatch/_profile/',
      icon: (
    ...
    {
      name: 'Facebook',
      url: 'https://www.facebook.com/profile.php?id=61582570537278',
      icon: (
        <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
    ...
    {
      name: 'Instagram',
      url: 'https://www.instagram.com/saramenomatch',
      icon: (
        <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
    ...
    {
      name: 'Twitter',
      url: 'https://twitter.com/getmenomatch',
      icon: (
        <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
    ...
    {
      name: 'LinkedIn',
      url: 'https://br.linkedin.com/in/menomatch-menomatch-195b5338a',
      icon: (
        <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
      ...
      <div className="max-w-6xl mx-auto px-4">
        ...
        <div className="flex flex-col items-center mb-8">
          ...
          <div className="flex justify-center space-x-6 mb-6">
            {socialLinks.map((social) => (
              <a
                ...
                className="text-gray-400 hover:text-primary-500 transition-all duration-300 transform hover:scale-110"
          ...
          <p className="text-center text-gray-400 text-sm max-w-md">
            Follow us for menopause tips, wellness advice, and community support 💜
          </p>
        </div>
        ...
        <div className="border-t border-gray-800 pt-8 text-center text-sm text-gray-400">
          <p>&copy; {new Date().getFullYear()} MenoMatch. All rights reserved.</p>
          <p className="mt-2">
            Empowering women through personalized menopause wellness 💜
          </p>
